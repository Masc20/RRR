    ...
    <div class="card-body">
      ...
      <div class="table-responsive" id="printableAreas">
        ...
        <tbody>
          ...
          $selPer = "SELECT SUM(percentage) as totPer  FROM tbl_category 
                    WHERE status = 'Show' ";
                    $selPerVar = $conn->query($selPer);
                    $newSelPar = $selPerVar->fetch_assoc();
              ...
              while($row = $resultCand->fetch_assoc()) {
                ...
                if ($resultCategory->num_rows > 0) {
                  ...
                  while($row = $resultCategory->fetch_assoc()) {
                    ...
                    // $total = ($newSelPar['totPer'] / 100) * $total;

                    $overall += $total;
                    $overall2 = $overall / $newSelPar['totPer'] * 100;
                  }
                    ?>
                    
                        <td align="center"><?php echo number_format($overall2, 2); ?>%</td>
                    <?php
